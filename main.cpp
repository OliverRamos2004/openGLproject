...
int main() {
    ...
    cfg.pointLights.resize(2);
    cfg.pointLights[0].position = glm::vec3(-4.0f, 5.0f, 0.0f);
    ...
    cfg.spotLights[0].diffuse = glm::vec3(0.9f, 0.85f, 0.75f);
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        drawWall(glm::vec3(0.0f, 2.5f, -6.0f), glm::vec3(12.0f, 5.0f, 0.2f));
        drawWall(glm::vec3(0.0f, 2.5f, 6.0f), glm::vec3(12.0f, 5.0f, 0.2f));
